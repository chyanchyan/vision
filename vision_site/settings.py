...
PROJECT_DIR = os.path.join(BASE_DIR, 'vision')
...
SECRET_KEY = '8le84vm6i&=u$%n(+@y=tte*u6o_u+=40o6y#sr&(2lqv79ybr'
...
INSTALLED_APPS = [
    ...
    'vision.apps.public',
    'vision.apps.accounts',
    'vision.apps.data_monitor',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(PROJECT_DIR, '../../qqdxm/vision/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(PROJECT_DIR, '../../qqdxm/vision/static'),
]
